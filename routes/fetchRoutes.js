...
app.post('/admin_login',
  passport.authenticate('admin-local', { successRedirect: '/',
...
app.delete(`/deleteProductCategory/:id`,(req,res)=>{
      ...
      app.post('/updateProductCategory/:id', (req, res) => {
        ...
        productCategory.updateOne({_id: productCategoryId},{productCategoryName: productCategoryName, details: details },function(err, data){
            if(err){
                console.log(err);
                return
            }
          ...
          app.post('/uploadProduct/:id', (req, res) => {
            ...
            productCategory.find({productCategoryName: productCategoryName}, function(err, data){
                if(err){
                    console.log(err);
                    return
                }
                ...
                let productCategoryId=data[0]._id;
                const x = new product({productName,price,specification,weight,length,productCategoryId})
    ...
    app.delete(`/deleteProduct/:id`,(req,res)=>{
        ...
        product.findOneAndRemove({_id: id}, function(err, data){
          ...
          app.post('/updateProduct/:id', (req, res) => {
            ...
            product.updateOne({_id: productId},{productName: productName, specification: specification, price: price, weight: weight, length: length},function(err, data){
                if(err){
                    console.log(err);
                    return
                }
