...
const EditDelete = (props) => {
  ...
  const handleUpdateProduct=(e)=>{
      ...
      axios.post(`/updateProduct/${props.productId}`, formData, {
        headers: {
 ...
 fetch(`/deleteProduct/${props.productId}`,{
         method: 'DELETE',
         headers: {
  ...
  return (
    <Fragment >
     ...
     <form style={{backgroundColor:"#e0e0e0"}} hidden={props.isAdmin} onSubmit={(e)=>{handleUpdateProduct(e)} }>
