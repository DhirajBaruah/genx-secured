        ...
        .then((result) => {
            ...
            for(var i=0; i<result.data.length; i++){
                if(result.data[i].status === 'pending'){
                    element.push(
                        <React.Fragment>
                        <div className="row container" style={{backgroundColor:"#e57373"}}>
                            <div className="col sm4">
                                <p >
                                ORDER ID : {result.data[i]._id} <br/><br/>
                                USER ID : {result.data[i].userDetails[0]._id} <br/> 
                                USER NAME : {result.data[i]._id} <br/><br/>
                                ADDRESS ID : {result.data[i].addressDetails[0]._id} <br/>
                                ADDREE LINE 1 : {result.data[i].addressDetails[0].addressLine1} <br/>
                                ADDRESS LINE 2 : {result.data[i].addressDetails[0].addressLine2} <br/>
                                CITY : {result.data[i].addressDetails[0].city} <br/>
                                STATE :{result.data[i].addressDetails[0].state} <br/>
                                PIN CODE : {result.data[i].addressDetails[0].pinCode} <br/>
                                NATION : {result.data[i].addressDetails[0].nation} <br/><br/>
                                PRODUCT ID : {result.data[i].productDetails[0]._id} <br/>
                                PRODUCT NAME : {result.data[i].productDetails[0].productName} <br/>
                                PRICE : {result.data[i].productDetails[0].price} <br/>
                                WEIGHT : {result.data[i].productDetails[0].weight} <br/>
                                LENGTH : {result.data[i].productDetails[0].length} <br/><br/>
                            ...
                            <div className="col sm4" >
                                <a  className=" waves-effect waves-light btn">PRINT ADDRESS</a> 
                            </div>
                            <div className="col sm4">
                                <a className=" waves-effect waves-light btn">START SHIPMENT</a> 
                            </div>
                        </div>
                        <br/>
                    ...
                    element.push(
                        ...
                        <div className="row container" style={{backgroundColor:"#ffb74d"}}>
                            <div className="col sm4">
                                <p >
                                    ORDER ID : {result.data[i]._id} <br/><br/>
                                    USER ID : {result.data[i].userDetails[0]._id} <br/> 
