...
const ModeOfPayment =(props) => {
  ...
  const placeOrder = ()=> {
      if(mode === 'cod'){
        ...
        axios.post('/placeOrder',formData,(req,res)=>{
                ...
                return(
                   ...
                   <div className="row">
                    ...
                    <div className="row">
                                ...
                                <p>
                                <label>
                                    <input name="group1" type="radio" onChange={() => setMode("card")} />
                                    <span>Credit/Debit Card</span>
                                </label>
                                </p>
                                <p>
                                <label>
                                    <input name="group1" type="radio" onChange={() => setMode("cod")}/>
                    ...
                    <div className="row">
                        <a class="waves-effect waves-light btn" onClick={()=>{if(mode==''){alert('Please select payment mode.')}else{placeOrder()}}}>Continue</a>
                   </div>
